       ...
       /* if(isset($_POST['add_to_wishlist'])){
        ...
        if(isset($_POST['add_to_wishlist'])){
            ...
            if($check_wishlist_numbers->rowCount() > 0){
               ...
               $insert_wishlist = $db->prepare("INSERT INTO `wishlist`(user_id, pid, name, price, image) VALUES(?,?,?,?,?)");
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    ...
                                    <div class="d-flex justify-content-center small text-warning mb-2">
                                        <div class="bi-star-fill"><?php echo $row['category']?></div>
                            ...
                            <div  class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <form action="" method="post">
                                    ...
                                    <div class="text-center"><button name="add_to_wishlist" class="btn btn-outline-dark mt-auto" href="#">Add to whishlist</button></div>
                                </form>
                            </div>
                        </div>
                   </form>
